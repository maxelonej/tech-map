...
<div id="headerContainer"></div>
    ...
    <div id="customAlert" style="display: none; position: fixed; z-index: 1; right: 20px; bottom: 20px; width: 30%; height: auto; overflow: auto; background-color: rgba(0,0,0,0.8); border-radius: 10px;">
    ...
    <input class="m9-input full_weight" id="full_weight" title="Сумма процентов всех компонентов" type="number" disabled>
